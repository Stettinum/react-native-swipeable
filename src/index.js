...
var Swipeable = function (_PureComponent) {
  ...
  function Swipeable() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Swipeable.__proto__ || Object.getPrototypeOf(Swipeable)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      if(x < 0) _this.props.rightDistanceActivationOffset(x / -rightActionActivationDistance);
      if(x > 0) _this.props.leftDistanceActivationOffset(x / leftActionActivationDistance);
      ...
      onPanResponderTerminationRequest: _this.props.panTerminationRequest ? _this._handlePanResponderEnd : (evt, gestureState) => false
...
Swipeable.propTypes = {
  ...
  panTerminationRequest: _propTypes.PropTypes.boolean,
  rightDistanceActivationOffset: _propTypes.PropTypes.func,
  leftDistanceActivationOffset: _propTypes.PropTypes.func,
};
Swipeable.defaultProps = {
  ...
  panTerminationRequest: true,
  rightDistanceActivationOffset: noop,
  leftDistanceActivationOffset: noop
};
